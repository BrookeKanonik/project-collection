...
module.exports = {
    ...
    addRecipe: async (req, res)=>{
        try{
            await Recipes.create({instructions: req.body.instructions, ingredient: req.body.ingredient, amount: req.body.amount, user: req.user.id, title: req.body.title}) //change Todo later
